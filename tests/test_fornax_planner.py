...
class FornaxPlannerTest(unittest.TestCase):
    ...
    def test_local_http_serving_smoke_validates_endpoint_and_sse(self) -> None:
        ...
        self.assertEqual(4, bundle["summary"]["backend_request_count"])
        ...
        self.assertEqual(6, bundle["summary"]["inflight_cleanup_count"])
        ...
        self.assertEqual(6, bundle["summary"]["lifecycle_request_count"])
        ...
        self.assertEqual(6, bundle["summary"]["lifecycle_cleanup_count"])
        self.assertEqual(30, bundle["summary"]["lifecycle_resource_allocated_count"])
        self.assertEqual(30, bundle["summary"]["lifecycle_resource_released_count"])
        ...
        self.assertEqual(6, bundle["lifecycle"]["accepted_request_count"])
    ...
    def test_local_http_serving_smoke_validates_target_fixture_backend(self) -> None:
        ...
        self.assertEqual(4, bundle["summary"]["target_fixture_run_count"])
        self.assertFalse(bundle["summary"]["target_model_parity"])
    ...
    def test_local_http_serving_smoke_validates_target_fixture_execution_probe(self) -> None:
        ...
        self.assertTrue(result["ok"], result["errors"])
        self.assertTrue(bundle["ok"])
        self.assertEqual(14, bundle["summary"]["check_count"])
        self.assertEqual(14, bundle["summary"]["passed_count"])
        self.assertTrue(bundle["summary"]["target_fixture_parity"])
