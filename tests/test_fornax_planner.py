...
class FornaxPlannerTest(unittest.TestCase):
    ...
    def test_local_http_serving_smoke_validates_endpoint_and_sse(self) -> None:
        ...
        self.assertEqual(9, bundle["summary"]["check_count"])
        self.assertEqual(9, bundle["summary"]["passed_count"])
        ...
        self.assertEqual(3, bundle["summary"]["inflight_cleanup_count"])
        self.assertTrue(bundle["summary"]["failure_semantics_verified"])
        self.assertTrue(bundle["summary"]["lifecycle_tracked"])
        self.assertEqual(3, bundle["summary"]["lifecycle_request_count"])
        self.assertEqual(4, bundle["summary"]["lifecycle_rejected_request_count"])
        self.assertEqual(3, bundle["summary"]["lifecycle_cleanup_count"])
        self.assertEqual(15, bundle["summary"]["lifecycle_resource_allocated_count"])
        self.assertEqual(15, bundle["summary"]["lifecycle_resource_released_count"])
        ...
        self.assertEqual(3, bundle["lifecycle"]["accepted_request_count"])
