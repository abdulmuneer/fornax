...
class FornaxPlannerTest(unittest.TestCase):
    ...
    def test_local_http_serving_smoke_validates_endpoint_and_sse(self) -> None:
        ...
        self.assertEqual(4, bundle["summary"]["inflight_cleanup_count"])
        ...
        self.assertEqual(4, bundle["summary"]["lifecycle_request_count"])
        ...
        self.assertEqual(4, bundle["summary"]["lifecycle_cleanup_count"])
        self.assertEqual(20, bundle["summary"]["lifecycle_resource_allocated_count"])
        self.assertEqual(20, bundle["summary"]["lifecycle_resource_released_count"])
        ...
        self.assertEqual(4, bundle["lifecycle"]["accepted_request_count"])
