...
> **V4 posture:** retained as a future G4 runbook. Do not execute or extend it at
> the expense of the active Phase 1/G2 physical-validation lane; proxy results are not G4.
