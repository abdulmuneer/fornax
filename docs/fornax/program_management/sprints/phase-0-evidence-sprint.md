...
> **V4 status:** historical v3 sprint. Its artifacts are retained, but the active
> work moved to `phase-0-5-engine-v0-sprint.md` after G1 `PROCEED` on 2026-07-10.

**Historical goal:** produce the evidence that fed the original v3 **G1
go/no-go**. This sprint is no longer the current focus; Phase 0.5 is complete and
Phase 1 physical validation is active as resources permit.
