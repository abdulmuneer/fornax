...
> **V4 posture:** remote-expert implementation is frozen. Existing MoE fixtures
> remain contract tests; enablement requires core Engine v0 plus physical evidence
> under ADR-0003.
